...
function createProj (projectile, rangeX, rangeY, damage, projSpd, maxMoveSpd=noone, moveSpdMargin=noone) {
...
function getPlayerControls() {
	...
	// Super attacking
	superKeyPressed = clamp(mouse_check_button_pressed(mb_right) || gamepad_button_check_pressed(0, gp_shoulderr), 0, 1);
